...
@Validated
@Tag(
        name = "REST APIs for Customers In MoneyBank",
        description = "REST APIs in MoneyBank to fetch customer details"
)
public class CustomerController {
    ...
    @Operation(
            ...
            description = "REST API to fetch Customer details based on account number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
